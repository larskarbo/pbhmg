...
module.exports = function(pb) {
    ...
    */
    ...
    PageViewController.prototype.preRender = function() {};
    /**
    * @method render
    * @param {Function} cb
    */
    PageViewController.prototype.render = function(cb) {
        ...
        this.service.getSingle(opts, function(err, content) {
            ...
            if(content.hero_image){
                self.ts.registerLocal('hero_image', self.renderHeroImage(content.hero_image));
                self.ts.registerLocal('hero_image_class', 'hero-image');
                self.ts.registerLocal('slogan', 'Guida turar i fantastiske omgivelsar');
            }
    ...
    PageViewController.prototype.renderHeroImage = function(heroImage){
        console.log('hero image: ',JSON.stringify(heroImage,null,2));
        return new pb.TemplateValue('style="background:url(' + heroImage + ')"', false)
    }
