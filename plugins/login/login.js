...
module.exports = function LoginModule(pb) {

    /**
     * Login - A sample for exemplifying what the main module file should
     * look like.
     *
     ...
     */
    Login.onInstallWithContext = function(context, cb) {
        cb(null, true);
    };
     ...
     * The result should be TRUE on success and FALSE on failure
     */
    Login.onUninstallWithContext = function (context, cb) {
     ...
     * The result should be TRUE on success and FALSE on failure
     */
    Login.onStartupWithContext = function (context, cb) {
